...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-22 14:03`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/96457dca-a440-4dad-905c-6ede6a75fa05.git
$ cd 96457dca-a440-4dad-905c-6ede6a75fa05
```
